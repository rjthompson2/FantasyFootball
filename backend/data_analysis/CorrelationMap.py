...
def rb(start_year, end_year):
    ...
    for year in range(start_year, end_year+1):
        ...
        df = df.append(rb_df)
    df = df[['PLAYER', 'RUSHING ATT', 'RUSHING YDS', 'RUSHING Y/A', 
        'RUSHING LG','RUSHING TD', 'REC', 'TGT', 'YDS', 'Y/R', 'TD', 
        'FL', 'ROST', 'POS', 'IT', 'IT/G', 'RA/G', 'Avg. Rushing Share',
       'Avg. Rushing Yards Share', 'G', 'FPTS','FPTS/G']]
