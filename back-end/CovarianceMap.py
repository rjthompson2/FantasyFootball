...
def qb(start_year, end_year):
    ...
    make_map(df, name='data/CovarianceMatrix/qb_matrix.png')
...
def rb(start_year, end_year):
    ...
    make_map(df, name='data/CovarianceMatrix/rb_matrix.png')
...
def wr_te(start_year, end_year):
    ...
    make_map(final_wr_df, name='data/CovarianceMatrix/wr_matrix.png')
    make_map(final_te_df, name='data/CovarianceMatrix/te_matrix.png')
